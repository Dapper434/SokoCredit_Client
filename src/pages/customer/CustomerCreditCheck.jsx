...
export default function CustomerCreditCheck() {
  ...
  return (
    <CustomerAuthFrame>
      <div className="flex flex-col items-center justify-center min-h-full px-8 py-12 bg-ground text-center gap-8">
        <div className="w-20 h-20 rounded-full border-4 border-primary-light flex items-center justify-center relative">
          <svg viewBox="0 0 24 24" fill="none" strokeWidth="2" className="w-9 h-9 text-primary" stroke="currentColor">
        ...
        <div>
          <h2 className="text-xl font-bold text-ink mb-2">Checking your SokoCredit history</h2>
