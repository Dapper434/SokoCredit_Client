    ...
    <div className="min-h-screen bg-ground flex flex-col">
      ...
      <header className="lg:hidden flex items-center justify-between px-5 py-3 bg-ground border-b border-border">
        ...
        <button
          ...
          className="px-3 py-1.5 text-xs font-semibold rounded bg-ground-dim text-status-missed-text hover:bg-status-missed-bg transition-colors cursor-pointer"
          title="Sign out"
        >
          Sign Out
        </button>
      ...
      <header className="hidden lg:flex items-center justify-between px-8 h-16 bg-surface border-b border-border sticky top-0 z-20">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            onClick={handleSignOut}
            className="px-3 py-1.5 text-xs font-semibold rounded bg-ground-dim text-status-missed-text hover:bg-status-missed-bg transition-colors"
          >
            Sign Out
          </button>
